...
export const BROWSER_LANG_MAP = {
  ...
  'eo':'esperanto', 'ht':'haitian_creole',
  'qu':'quechua', 'gn':'guarani', 'nah':'nahuatl',
  'jam':'jamaican_patois', 'ay':'aymara', 'arn':'mapuche', 'yua':'maya', 'quc':'kiche',
  'nv':'navajo', 'chr':'cherokee', 'cr':'cree_syl', 'cr-cans':'cree_syl',
  'guc':'wayuu', 'emp':'embera', 'wca':'yanomami',
  'sq':'albanian', 'be':'belarusian', 'mk':'macedonian', 'sl':'slovenian',
'ig':'igbo', 'so':'somali', 'ln':'lingala', 'sn':'shona', 'ny':'nyanja',
'om':'oromo', 'ti':'tigrinya', 'lg':'luganda', 'tn':'setswana', 'wo':'wolof', 'bm':'bambara', 'ff':'fula', 'pcm':'nigerian_pidgin',
'ps':'pashto', 'az':'azerbaijani', 'ku':'kurdish', 'ka':'georgian', 'hy':'armenian',
'io':'ido', 'ia':'interlingua', 'jbo':'lojban', 'tok':'toki_pona', 'und-zsye':'emoji',
  'my':'burmese', 'jv':'javanese', 'km':'khmer', 'lo':'lao', 'ms':'malay',
  'ml':'malayalam', 'ne':'nepali', 'si':'sinhala', 'su':'sundanese',
  'tlh_hol':'klingon', 'tlh_piqad':'klingon_piqad',
};
...
export const LANG_BCP47 = {
  ...
  haitian_creole:'ht', quechua:'qu', guarani:'gn', nahuatl:'nah',
  jamaican_patois:'jam', aymara:'ay', mapuche:'arn', maya:'yua', kiche:'quc',
  navajo:'nv', cherokee:'chr', cree_syl:'cr-Cans',
  wayuu:'guc', embera:'emp', yanomami:'wca',
  albanian:'sq', belarusian:'be', macedonian:'mk', slovenian:'sl',
igbo:'ig', somali:'so', lingala:'ln', shona:'sn', nyanja:'ny',
oromo:'om', tigrinya:'ti', luganda:'lg', setswana:'tn', wolof:'wo', bambara:'bm', fula:'ff', nigerian_pidgin:'pcm',
pashto:'ps', azerbaijani:'az', kurdish:'ku', georgian:'ka', armenian:'hy',
ido:'io', interlingua:'ia', lojban:'jbo', toki_pona:'tok', emoji:'und-Zsye',
  burmese:'my', javanese:'jv', khmer:'km', lao:'lo', malay:'ms',
  malayalam:'ml', nepali:'ne', sinhala:'si', sundanese:'su',
