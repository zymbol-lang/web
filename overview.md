...
**This is not the front page any more.** It is kept as it was — the showcase, the
operator table and the manuals all still work — but nothing here is being updated.
The current front page is [/index.md](index.md).

This is the Markdown representation of <https://zymbol-lang.org/overview.html>.
Other pages: [/index.md](index.md), [/install.md](install.md),
