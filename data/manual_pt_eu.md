...
arr = arr[1]$~ 99        // actualização funcional — devolve novo array
```
...
| `@>`      | continuar                          | `$\|`         | filter                        |
| `->`      | lambda                             | `$<`          | reduce                        |
| `$^+`     | ordenar crescente (primitivos)     | `$^-`         | ordenar decrescente           |
| `$^`      | ordenar com lambda comparador      |               |                               |
...
| `c\|..\|` | formato com vírgula               | `e\|..\|`     | científico                    |
